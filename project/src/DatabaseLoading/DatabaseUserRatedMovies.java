...
public class DatabaseUserRatedMovies implements RatingsDataLoader {

	private ArrayList<String[]> fileList;
	private String readerpath;//="C:\Users\eleni\eclipse-workspace\Film Library\data files";
	private  Scanner inputReader;
	
	public DatabaseUserRatedMovies(String readerpath) {
	...
	public ArrayList<String[]> getUserRatedMoviesArrayList(){
		return fileList;
	}
